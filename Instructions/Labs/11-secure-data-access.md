...
En este laboratorio, aplicará la seguridad de nivel de fila para asegurarse de que un vendedor solo pueda analizar los datos de ventas de las regiones que tenga asignadas. Aprenderá a:

- Implemente la Seguridad de nivel de fila (RLS) en Power BI.
- Cree y pruebe un rol mediante USERPRINCIPALNAME().
...
1. Para asignar un filtro, seleccione la tabla **Comercial (Rendimiento)** y, a continuación, seleccione **Cambiar al editor de DAX** en la sección **Reglas**.
...
1. Fíjese en el mensaje emergente rojo, encima de la página del informe, que describe el contexto de seguridad de la prueba.
...
1. Para detener las pruebas, en el lado derecho del mensaje emergente rojo, seleccione **Detener visualización**.
